...
const styles = StyleSheet.create({
  ...
  qrGlyph: { fontSize: 56 },
  qrNote: { fontSize: fontSize.sm, color: colors.textMuted, textAlign: 'center', lineHeight: 18 },
  amount: { fontSize: fontSize.h1, fontWeight: fontWeight.bold, color: colors.textPrimary },
  countdown: { fontSize: fontSize.md, color: colors.textMuted },
  ...
  detailLabel: { fontSize: fontSize.xs, color: colors.textMuted, letterSpacing: 1 },
  ...
  refundAmount: { fontSize: fontSize.h1, fontWeight: fontWeight.bold, color: colors.textPrimary },
  refundStatus: { fontSize: fontSize.md, color: colors.textMuted },
  ...
  stepLabel: { fontSize: fontSize.lg, color: colors.textMuted },
  stepLabelActive: { color: colors.textPrimary, fontWeight: fontWeight.medium },
});
