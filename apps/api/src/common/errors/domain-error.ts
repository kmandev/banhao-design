...
const STATUS_BY_CODE: Record<ErrorCode, HttpStatus> = {
  ...
  CUSTOMER_EMAIL_REQUIRED: HttpStatus.CONFLICT,
  // Refund initiation (Q-020 Slice 1, DEC-057/058/059).
  ORDER_NOT_REFUND_ELIGIBLE: HttpStatus.CONFLICT,
  PAYMENT_NOT_REFUNDABLE: HttpStatus.CONFLICT,
  REFUND_ALREADY_EXISTS: HttpStatus.CONFLICT,
