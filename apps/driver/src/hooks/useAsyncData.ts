 ...
 * every screen has to handle the states rather than rendering an empty view
 * while data is in flight.
 *
 * Same contract as `apps/customer/src/hooks/useAsyncData.ts`, deliberately —
 * it is the established pattern in this monorepo and this slice introduces no
 * second one.
 */
